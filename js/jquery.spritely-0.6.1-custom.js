...
(function($) {
    $._spritely = {
        ...
        getInstances : function(el_id){
            return $._spritely.instances[el_id];
        }
    };
    ...
    jQuery.fn.extend({
        ...
        spRandom: function(options) {
            ...
            if (!$._spritely.instances[el_id].stop_random) {
                ...
                var prevPosition = $('#' + el_id).position();

                if(l>prevPosition.left)
                {
                    $('#' + el_id).spState(1);
                }
                else
            ...
            $._spritely.spRandomTimeout = window.setTimeout(function() {
                $('#' + el_id).spRandom(options);
            }, options.speed + options.pause)
            return this;
        },
        spStopRandom : function() {
            if($._spritely.spRandomTimeout)
            {
                clearTimeout($._spritely.spRandomTimeout);
                $._spritely.spRandomTimeout = null;
            }
            return this;
        },
